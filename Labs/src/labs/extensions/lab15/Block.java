...
public class Block implements Locatable {
   ...
   //add a toString() method  - x , y , width, height, color
	...
	public void updateQuadBox() {
		if(this instanceof Paddle) {
			quadBox = new QuadBox(xPos - 30, yPos, 30, height,xPos + width, yPos, 30, height,xPos, yPos - 30, width, 30,xPos, yPos + height, width, 30);
		}
	}
